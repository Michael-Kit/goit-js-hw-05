...
// Об’єкт profile описує профіль користувача на ігровій платформі. У його властивостях зберігається ім’я профілю username 
// та кількість активних годин playTime, проведених у грі.

const profile = {
    username: "Jacob",
  playTime: 300,
  // Метод getInfo повертає інформацію про профіль
  getInfo() {
    return `${this.username} has ${this.playTime} active hours!`;
  },
  // Метод changeUsername змінює ім'я профілю
  changeUsername(newName) {
    this.username = newName;
  },
  // Метод updatePlayTime збільшує кількість ігрових годин
